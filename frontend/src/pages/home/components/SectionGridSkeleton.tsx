const SectionGridSkeleton = () => {
  // Renders a skeleton loader for a grid section, typically used to indicate loading state
  return (
    <div className="mb-8">
      <div className="h-8 w-48 bg-zinc-800 rounded mb-4 animate-pulse" />
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          // Maps over an array of length 4 to create 4 skeleton items in the grid
